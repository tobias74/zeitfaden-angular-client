...
angular.module('ZeitfadenApp').directive('zfUserTraceMap',function(){
  return {
    restrict: 'EA',
    require: '?ngModel',
    scope:{
    ...
    link: function(scope,element,attrs,ngModel){
      ...
      scope.$watch('myTraces', function(){
        ...
        var removeAllFlightPaths = function(){
        ...
        var paintPolylineByStations = function(polyStations)
        {
          ...
          var paintPolyline = function(coordinates, userId){
          ...
          paintPolyline(coordinates,polyStations[0].userId);
        ...
        var showInfoWindow = function(){
          ...
          info.setPosition(new google.maps.LatLng(event.latLng.lat(),event.latLng.lng()) );
          info.open(googleMap);
        };
